...
;*** UART SETUP ****
  ...
  MOVWF RC1STA
  BANKSEL TX1STA
  MOVLW 0x26 ;00100110 ENABLE TRANSMITTER, HIGH SPEED MODE, ASYNCHRONOUS
  MOVWF TX1STA
...
;************************************************************************************
 ...
 INTERPRETUART:
     ...
     MOVF UART_RX_BYTE, W
     XORLW 0X45
     BTFSC STATUS,2 ;IF RECEIVED BYTE IS ENABLE COMMAND, SET ENABLE FLAG FOR NEXT RECEIVE BYTE
     BSF UART_MODE, 4
     MOVF UART_RX_BYTE, W
     XORLW 0X44
     BTFSC STATUS,2 ;IF RECEIVED BYTE IS DISABLE COMMAND, SET DISABLE FLAG FOR NEXT RECEIVE BYTE
     BSF UART_MODE, 3
     MOVF UART_RX_BYTE, W
     XORLW 0X43
     BTFSC STATUS,2 ;IF RECEIVED BYTE IS CLEAR COMMAND, GOTO CLEAR TARGETS
     GOTO CLEARTARGETS
     MOVF UART_RX_BYTE, W
     XORLW 0X41
     BTFSC STATUS,2 ;IF RECEIVED BYTE IS CHANGE TARGET COMMAND, SET CHANGE FLAG FOR NEXT RECEIVE BYTE
     BSF UART_MODE, 2
     RETURN
 ...
 DEVICEVERIFICATION:
     ...
     MOVLW 0X4C
     MOVWF TX1REG ;TRANSMIT FIRST HALF OF DEVICE VERIFICATION
     BANKSEL PORTA
 ...
 TXVERIFY:
     BANKSEL TX1REG
     MOVLW 0X41
     MOVWF TX1REG ;TRANSMIT THE SECOND HALF OF DEVICE VERIFICATION
     BANKSEL PORTA
