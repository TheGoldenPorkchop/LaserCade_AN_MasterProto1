...
UART_MODE EQU 0x23 ;UART MODE FLAGS FOR UART ISR
UART_RX_BYTE EQU 0x24 ;DATA RECEIVED BY UART

PLAYER_NUMBER EQU 0x25 ;FOR THE UPDATE PLAYER COLOR COMMAND
GREEN EQU 0x26 ;FOR THE UPDATE PLAYER COLOR COMMAND
RED EQU 0x27 ;FOR THE UPDATE PLAYER COLOR COMMAND
BLUE EQU 0x28 ;FOR THE UPDATE PLAYER COLOR COMMAND
DID_TIME_OUT EQU 0x29 ;TIMEOUT CHECK
...
;************************************************************************************
 ...
 CHECKR_W: ;Z=1 Not Busy
    ...
    UARTRX:
     BANKSEL PIE1
     BCF ((PIE1) and 07Fh), 5 ;DISABLES INTERRUPTS FROM RECEIVING DATA
     BANKSEL PORTA
 ...
 INTERPRETUART:
  ...
  BANKSEL PIR1
  BTFSS ((PIR1) and 07Fh), 5 ;FINISHED RECEIVING?
  GOTO TIMELOOP ;NO
  ...
  RETURN
     ...
     ENABLE_RECEIVE_INT:
  BANKSEL PIE1
  BSF ((PIE1) and 07Fh), 5 ;REENABLES INTERRUPTS FROM RECEIVING DATA
  RETURN
# 34 "../LA_Master.asm" 2
...
INTERRUPT:
  ...
  GOTO UARTRECEIVE
  BTFSC ((PIR1) and 07Fh), 1 ;IF INTERRUPTED BY TMR2, GOTO TIMEOUT
  GOTO TIMEOUT
