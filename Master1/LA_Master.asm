...
INTERRUPT:
		...
		GOTO	    UARTRECEIVE
		BTFSC	    TXIF			;IF INTERRUPTED BY UART TRANSMIT, GOTO UARTTRANSMIT
		GOTO	    UARTTRANSMIT
...
MAIN:
		;MOVLW	    0x02
		;MOVWF	    CURRENT_ADDRESS	;STORE RECEIVED BYTE IN UART_RX_BYTE
		;MOVLW	    0x02
		;MOVWF	    WRITE_DATA	;STORE RECEIVED BYTE IN UART_RX_BYTE
